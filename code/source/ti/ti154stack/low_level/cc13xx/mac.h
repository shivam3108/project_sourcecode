...
#ifdef COMBO_MAC
extern antennaSettingFp_t pMacRfAntSwitchSel;
#endif
...
extern RF_Mode *pRfPropTableOld;
#endif
#if defined(COMBO_MAC) || defined(FREQ_2_4G)
extern RF_Mode *pRfIeeeTable;
#endif
...
#if defined(COMBO_MAC) || !defined(FREQ_2_4G)
extern bool macRadioRequestAccess();
extern void macClientSwitchCb(RF_Handle h, RF_ClientEvent event, void* arg);
#endif
/*******************************************************************************
 */
