/******************************************************************************
 ...
 @brief This file contains the defines for every High Level MAC function which
        can be mapped to either itself (for Flash-Only build), or to jump table
        offset in flash (ROM build). The latter can be used to relocate any
        function to flash in the event that software needs to be replaced.
...
#define MAP_macSymbolTimerRolloverCallback         ((void               (*) (void))                                                                                      R2R_JT_OFFSET(57))
#define MAP_macSymbolTimerTriggerCallback          ((void               (*) (void))                                                                                      R2R_JT_OFFSET(58))
...
#define MAP_macBuildHeader                         ((uint8              (*) (macTx_t *, uint8, sAddr_t *, uint16, uint8))                                                       R2R_JT_OFFSET(89))
...
#define MAP_macTimerUpdateSymbolTimer              ((void               (*) (void))                                                                                      R2R_JT_OFFSET(209))
