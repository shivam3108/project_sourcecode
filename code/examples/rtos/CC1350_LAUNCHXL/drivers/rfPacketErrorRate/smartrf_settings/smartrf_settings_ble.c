...
const RF_TxPowerTable_Entry PROP_RF_txPowerTableBle[] = 
{ 
...
const uint8_t PROP_RF_txPowerTableBleSize = sizeof(PROP_RF_txPowerTableBle)/sizeof(RF_TxPowerTable_Entry);
